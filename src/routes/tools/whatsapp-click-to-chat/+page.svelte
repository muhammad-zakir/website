	...
	<div class="mx-auto max-w-xl">
		<ScrollReveal>
			<div class="mb-8 text-center sm:text-left">
				...
				<h1 class="text-2xl font-bold text-graphite-50 sm:text-3xl">WhatsApp Click-to-Chat</h1>
				<p class="mt-2 text-sm text-graphite-300">
					Enter a phone number to generate a direct WhatsApp chat link. Non-numeric characters are
		...
		<ScrollReveal delay={100}>
			<GlassCard>
				<div class="space-y-5">
					...
					<div>
						<label
							for="country-code-select"
							class="mb-2 block text-sm font-medium text-graphite-200"
						>
							Country
						</label>
						<SearchableSelect
					...
					<div>
						...
						<input
							...
							class="w-full rounded-lg border border-graphite-600/50 bg-graphite-700/50 px-4 py-2.5 text-sm text-graphite-100 transition-colors duration-200 placeholder:text-graphite-500 focus:border-pastel-300/50 focus:ring-1 focus:ring-pastel-300/30"
						/>
					...
					<div>
						...
						<textarea
							...
							class="w-full resize-none rounded-lg border border-graphite-600/50 bg-graphite-700/50 px-4 py-2.5 text-sm text-graphite-100 transition-colors duration-200 placeholder:text-graphite-500 focus:border-pastel-300/50 focus:ring-1 focus:ring-pastel-300/30"
						></textarea>
					</div>
					...
					{#if generatedWhatsappLink}
						...
						>
							...
							<p class="font-mono text-xs break-all text-pastel-300">{generatedWhatsappLink}</p>
						</div>
					{/if}
					...
					<div class="flex flex-col gap-2 sm:flex-row">
						<a
							...
							onclick={(event) => {
								if (!generatedWhatsappLink) event.preventDefault();
							}}
						>
							Open in WhatsApp
						</a>
